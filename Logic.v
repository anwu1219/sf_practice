...
Lemma double_neg_eq: forall a b, a = b -> negb a = negb b.
Proof.
  intros; destruct a; destruct b; try reflexivity; auto.
Qed.
...
Proof.
  ...
  - destruct IHn.
    case_eq (evenb n); intros.
    + exists x; rewrite H0 in H.
      apply double_neg_eq in H0.
      rewrite <- evenb_S in H0.
      rewrite H0.
      rewrite H; reflexivity.
    + exists (S x); rewrite H0 in *.
      apply double_neg_eq in H0.
      rewrite <- evenb_S in H0.
      rewrite H0.
      simpl.
