...
Proof.
  ...
  - intro.
    ...
    + destruct n.
      * apply ev'_2.
      * assert (ev' 2) by apply ev'_2.
        assert (S (S (S n)) = S n + 2).
          clear H H0 IHev.
          induction n.
          reflexivity.
          simpl.
...
Definition fR m n := m + n.

Theorem R_equiv_fR : forall m n o, R m n o <-> fR m n = o.
Proof.
  intros; split; intros.
  * induction H; simpl; try reflexivity.
    + rewrite IHR; try reflexivity.
    + unfold fR in IHR; rewrite <-plus_n_Sm, IHR; reflexivity.
    + unfold fR in *; simpl in IHR; rewrite <- plus_n_Sm in IHR.
      do 2 apply eq_add_S in IHR; apply IHR.
  ...
  * unfold fR in *.
    ...
    apply c1.
    apply c3; apply IHn.
    intros; simpl; apply c2; apply IHm.
Qed.
